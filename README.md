...
Set the `CurrentDemo` value [MainActivity.kt:32](https://github.com/yhpark/androidx-paging3-issues/blob/master/app/src/main/java/com/example/myapplication/MainActivity.kt#L32) to one of the three issues in order to reproduce the issue.
